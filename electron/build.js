...
function startBuild(data) {
    ...
    if (data.id === 'app') {
        ...
        const eeuiRun = `docker run -it --rm -v ${eeuiDir}:/work -w /work kuaifan/eeui-cli:0.0.1`
        ...
        if (argv[3] === "setting") {
            child_process.execSync(`${eeuiRun} eeui setting`, {stdio: "inherit", cwd: "resources/mobile"});
        }
        if (argv[3] === "publish") {
